                            ...
                            <form action="{{ route('update_post', $post->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="description" placeholder="description" name="description"
                                        value="{{ $post->description }}" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label">Image</label>
                                    <input type="file" placeholder="image" name="image" value="{{ $post->image }}" class="form-control">
                                    <input type="hidden" placeholder="image" name="previous_image" value="{{ $post->image }}" class="form-control">
                                </div>
